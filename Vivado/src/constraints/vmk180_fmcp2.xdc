#---------------------------------------------------------------------
# Constraints for Opsero Ethernet FMC Max ref design for VMK180-FMCP2
#---------------------------------------------------------------------
...
set_property PACKAGE_PIN K7 [get_ports {sgmii_port_gtx_p[0]}]; # DP0_C2M_P
set_property PACKAGE_PIN K6 [get_ports {sgmii_port_gtx_n[0]}]; # DP0_C2M_N
set_property PACKAGE_PIN K2 [get_ports {sgmii_port_grx_p[0]}]; # DP0_M2C_P
set_property PACKAGE_PIN K1 [get_ports {sgmii_port_grx_n[0]}]; # DP0_M2C_N
...
set_property PACKAGE_PIN K11 [get_ports {sgmii_port_gtx_p[1]}]; # DP1_C2M_P
set_property PACKAGE_PIN K10 [get_ports {sgmii_port_gtx_n[1]}]; # DP1_C2M_N
set_property PACKAGE_PIN J4 [get_ports {sgmii_port_grx_p[1]}]; # DP1_M2C_P
set_property PACKAGE_PIN J3 [get_ports {sgmii_port_grx_n[1]}]; # DP1_M2C_N
...
set_property PACKAGE_PIN J9 [get_ports {sgmii_port_gtx_p[2]}]; # DP2_C2M_P
set_property PACKAGE_PIN J8 [get_ports {sgmii_port_gtx_n[2]}]; # DP2_C2M_N
set_property PACKAGE_PIN H2 [get_ports {sgmii_port_grx_p[2]}]; # DP2_M2C_P
set_property PACKAGE_PIN H1 [get_ports {sgmii_port_grx_n[2]}]; # DP2_M2C_N
...
set_property PACKAGE_PIN H11 [get_ports {sgmii_port_gtx_p[3]}]; # DP3_C2M_P
set_property PACKAGE_PIN H10 [get_ports {sgmii_port_gtx_n[3]}]; # DP3_C2M_N
set_property PACKAGE_PIN H6 [get_ports {sgmii_port_grx_p[3]}]; # DP3_M2C_P
set_property PACKAGE_PIN H5 [get_ports {sgmii_port_grx_n[3]}]; # DP3_M2C_N
