...
set_property PACKAGE_PIN BJ36 [get_ports sgmii_port_0_txp]; # DP0_C2M_P
set_property PACKAGE_PIN BK36 [get_ports sgmii_port_0_txn]; # DP0_C2M_N
set_property PACKAGE_PIN BM37 [get_ports sgmii_port_0_rxp]; # DP0_M2C_P
set_property PACKAGE_PIN BN37 [get_ports sgmii_port_0_rxn]; # DP0_M2C_N
...
set_property PACKAGE_PIN BG37 [get_ports sgmii_port_1_txp]; # DP1_C2M_P
set_property PACKAGE_PIN BH37 [get_ports sgmii_port_1_txn]; # DP1_C2M_N
set_property PACKAGE_PIN BM38 [get_ports sgmii_port_1_rxp]; # DP1_M2C_P
set_property PACKAGE_PIN BN39 [get_ports sgmii_port_1_rxn]; # DP1_M2C_N
...
set_property PACKAGE_PIN BJ38 [get_ports sgmii_port_2_txp]; # DP2_C2M_P
set_property PACKAGE_PIN BK38 [get_ports sgmii_port_2_txn]; # DP2_C2M_N
set_property PACKAGE_PIN BM41 [get_ports sgmii_port_2_rxp]; # DP2_M2C_P
set_property PACKAGE_PIN BN41 [get_ports sgmii_port_2_rxn]; # DP2_M2C_N
...
set_property PACKAGE_PIN BG39 [get_ports sgmii_port_3_txp]; # DP3_C2M_P
set_property PACKAGE_PIN BH39 [get_ports sgmii_port_3_txn]; # DP3_C2M_N
set_property PACKAGE_PIN BM43 [get_ports sgmii_port_3_rxp]; # DP3_M2C_P
set_property PACKAGE_PIN BN43 [get_ports sgmii_port_3_rxn]; # DP3_M2C_N
